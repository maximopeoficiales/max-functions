...
/* 
     ...
     Plugin URI:
     Description: A�0�9ade endpoints y modificaciones necesarios para maxco-proyect
     Version: 1.0.0
...
function max_functions_init()
{
	...
	$labels = array(
		...
		'items_list_navigation' => __('Navegaci��n de Configuraciones', 'max_functions'),
